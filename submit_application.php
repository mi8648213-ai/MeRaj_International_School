...
try {
    ...
    error_log('MeRaj application error: ' . $ex->getMessage());
    echo '<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="assets/css/style.css"></head><body class="center"><div class="card"><h2>Application could not be submitted</h2><p>Please check the form and try again. If the problem continues, contact the school.</p><a class="btn" href="apply.php">Go Back</a></div></body></html>';
}